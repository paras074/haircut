...
var cardData = [
  ...
  var useyourHair = [
    { "imghair": 'Image_1.png', "titleHair": 'Launch Govern to Cure', "discriptionHair": 'HAIR holders have governance rights over our treasury, and are asked to decide what research we fund, and how our IP portfolio is managed', "FUNDEDHAIR": 'GOVERNANCE FORUM',"imgarrow" :'rightvector.png' },
  { "imghair": 'Image_2.png', "titleHair": 'Stake for Alpha', "discriptionHair": 'HAIR holders can use their tokens to receive confidential information, including early-access to our research data. Alpha enables HAIR holders to earn more HAIR.', "FUNDEDHAIR": 'STAKE YOUR HAIR',"imgarrow" :'rightvector.png' },
  { "imghair": 'Image_3.png', "titleHair": 'Purchase with Discounts', "discriptionHair": 'HAIR holders receive a 25% discount on all HairDAO products, including our patented treatments and trademarked software.', "FUNDEDHAIR": 'STORE COMING SOON',"imgarrow" :'rightvector.png' },
  ...
  return (
    ...
    <h1 className={styles.First_heading_top}>Grow your HAIR</h1>
        ...
        <div className={`${styles.d_flex} ${styles.gap_2}`}>
          <a href="https://discord.com/invite/sNAm9QbfAz" className={`${styles.btn} ${styles.btn_dark_cstm}`}>Earn Hair</a>
...
{useyourHair.map((item, index) => (
  <div key={index} className={styles.box_container_img_text}>
    <div className={styles.m_all}>
    <img src={item.imghair} className={styles.Illustration_img} alt="card_main_1" />
    <h2>{item.titleHair}</h2>
    <p>{item.discriptionHair}</p>
    <p className={`${styles.card_link2} ${item.FUNDEDHAIR === 'STORE COMING SOON' ? styles.card_link3 : ''}`}>
      {item.FUNDEDHAIR}
...
<div className={`${styles.row} ${styles.last_section}`}>
  ...
  <div className={styles.box_container_after_img_text}>
    <div className={styles.after_contain_second}>
    <div className={styles.distribution_all_second}>
    <h2>A NOTE FROM OUR LEGAL TEAM</h2>
    <p className={styles.note_p}>HAIR is a governance token, serving solely for decision-making within the DAO. It does not represent an investment or an opportunity for economic gain. Holders should not expect any form of financial return from purchasing this token. Its purpose is exclusively to enable participation in governance decisions, without any implied promise of financial profit.</p>
   </div>
   </div>
   </div>
</div>
