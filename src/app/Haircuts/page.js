      ...
      <div className={styles.container}>
        <div className={styles.Headingrow}>
          <div className={styles.col_sec}>
            <h1 className={styles.colsech1}>Hair Cuts #5</h1>
            <h5 className={styles.fwbold}>September1 - December31,2023</h5>
          </div>
        ...
        <div className={styles.btnrow}>
          ...
          <a href="https://e.issuu.com/embed.html?d=hair_cuts_5&u=hairdao" target="blank">
        ...
        <div className={styles.hyper_links}>
          ...
          <div className={styles.haircut_img}>
            ...
            <a href="/Haircut3">
              ...
              <h4 className={`${styles.fw_bold} ${styles.mt-2}`}>Hair Cuts 3</h4>
            </div>
            <div class={styles.image_container}>
                <a href="/Haircut2">
              <img
